                            ...
                            <?php
                                ...
                                '<td>'+ 
                                    '<ul class="addremove">'+
                                        ...
                                        '<li>  <button type="button" class="btn btn-xs red" data-toggle="modal" data-target="#myModal'+value['bike_id']+'" >'+
                                        '<i class="fa fa-minus-square"></i>'+
                                        '</button> </li>'+

                                        '<!-- Modal -->'+
                                        '<div id="myModal'+value['bike_id']+'" class="modal fade" role="dialog">'+
                                          '<div class="modal-dialog">'+
                                            ...
                                            '<div class="modal-content">'+
                                              ...
                                              '<div class="modal-body">'+
                                                '<p>Are you sure you want to delete <strong>'+value['bike_number']+'</strong> ?</p>'+
                                              '</div>'+
                                              '<div class="modal-footer">'+
                                                '<button type="button" class="btn btn-default btn-success pull-left" data-dismiss="modal">Close</button>'+
                                                '<button type="button" class="btn btn-default red delete_btn" data-dismiss="modal" id="'+value['bike_id']+'">Delete</button>'+
                                              '</div>'+
                                            '</div>'+
