                             ...
                             <?php
                                ...
                                '<td>'+ 
                                    '<ul class="addremove">'+
                                        ...
                                        '<li>  <button type="button" class="btn btn-xs red" data-toggle="modal" data-target="#myModal'+value['de_id']+'" >'+
                                        '<i class="fa fa-minus-square"></i>'+
                                        '</button> </li>'+

                                        '<!-- Modal -->'+
                                        '<div id="myModal'+value['de_id']+'" class="modal fade" role="dialog">'+
                                          '<div class="modal-dialog">'+
                                            ...
                                            '<div class="modal-content">'+
                                              ...
                                              '<div class="modal-footer">'+
                                                ...
                                                '<button type="button" class="btn btn-default red delete_btn" data-dismiss="modal" id="'+value['de_id']+'">Delete</button>'+
                                              '</div>'+
                                            '</div>'+
