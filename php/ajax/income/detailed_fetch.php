<?php 
	...
	{
		$dd_id = $_GET['dd_id'];
		$sql = "SELECT * FROM income WHERE status=1 and datee BETWEEN '$from_datee' AND '$to_datee' and dd_id=$dd_id ";
	}
	else
	{
		$sql = "SELECT * FROM income WHERE status=1 and datee BETWEEN '$from_datee' AND '$to_datee' ";
	}
