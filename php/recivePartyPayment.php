      ...
      var e=function() {
          ...
          e.dataTable( {
              language: {
                  ...
                  , emptyTable:"No data available in table", info:"Showing _START_ to _END_ of _TOTAL_ entries", infoEmpty:"No entries found", infoFiltered:"(filtered1 from _MAX_ total entries)", lengthMenu:"_MENU_ entries", search:"Search:", zeroRecords:"No matching records found", paginate: {
                      previous: "Prev", next: "Next", last: "Last", first: "First"
                  }
              }
              , buttons:[ {
                  extend:"print", orientation: 'landscape', pageSize: 'LEGAL', exportOptions: {
                      columns: ':visible'
                  }
                    ...
                    customize: function ( win ) {
                            ...
                            $(win.document.body)
                              ...
                              .prepend('<div class="row" style="page-break-inside: avoid;">'+
                                '<img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/TMS/php/ajax/header.jpg" style="top:0; left:0;" />')
                              .append('<img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/TMS/php/ajax/footer.jpg" /> </div>');
                        }
              }
              , {
