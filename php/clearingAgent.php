                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                ...
                                <span class="caption-subject bold uppercase"> <?php $text = isset($_SESSION['disable_btn'])?'View':'Add New'; echo $text; ?> Clearing Agent</span>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" role="form"  method="post">
                                <div class="form-body">
                                    <div class="row hidden" id="agent_id_div"> 
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">ID:</label>
                                            <div class="col-md-3">
                                              <input type="number" name="agent_id" id="agent_id" readonly class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row"> 
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function(){
                    ...
                    var table = $.each(data,function(index,value){
                        ...
                        $('tbody').append('<tr index="'+i+'" class="odd gradeX">'+
                            <?php
                                ...
                                '<td>'+ 
                                    '<ul class="addremove">'+
                                        '<li> <button class="btn btn-xs green update_btn" id="'+value['agent_id']+'" type="button">  '+
                                        '<i class="fa fa-plus-square"></i>'+
                                        '</button> </li>'+

                                        '<!-- Trigger the modal with a button -->'+                                        
                                        '<li>  <button type="button" class="btn btn-xs red" data-toggle="modal" data-target="#myModal'+value['agent_id']+'" >'+
                                        '<i class="fa fa-minus-square"></i>'+
                                        '</button> </li>'+

                                        '<!-- Modal -->'+
                                        '<div id="myModal'+value['agent_id']+'" class="modal fade" role="dialog">'+
                                          '<div class="modal-dialog">'+
                                            ...
                                            '<div class="modal-content">'+
                                              ...
                                              '<div class="modal-footer">'+
                                                ...
                                                '<button type="button" class="btn btn-default red delete_btn" data-dismiss="modal" id="'+value['agent_id']+'">Delete</button>'+
                                              '</div>'+
                                            '</div>'+
        ...
        function updateClick()
        {
            ...
            $('#agent_id_div').removeClass('hidden');
        ...
        $('form').submit(function(e){
           ...
           {
                update(agent_id,name,contact,address);
           }
           else
           {
